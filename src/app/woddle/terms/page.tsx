...
export default function WoddleTermsPage() {
  return (
    <main>
      <h1>Terms &amp; Conditions - Woddle</h1>
      <p>
      ...
      <p>
        Brendan McKenzie is committed to ensuring that the app is as useful and
      ...
      <p>
        The Woddle app stores and processes personal data that you have provided
        to us, to provide my Service. It’s your responsibility to keep your
        ...
        features and it could mean that the Woddle app won’t work properly or at
        all.
      </p>
      <p>
        You should be aware that there are certain things that Brendan McKenzie
        ...
        can be Wi-Fi or provided by your mobile network provider, but Brendan
        McKenzie cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Brendan McKenzie cannot always take responsibility
        ...
        avail the Service, Brendan McKenzie cannot accept responsibility.
      </p>
      <p>
        With respect to Brendan McKenzie’s responsibility for your use of the
        ...
        we can make it available to you. Brendan McKenzie accepts no liability
      ...
      <p>
        ...
        using the app. Brendan McKenzie does not promise that it will always
      ...
      <p>These terms and conditions are effective as of 2022-03-08</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at hello@brendanmckenzie.com.
      </p>
    </main>
  );
}
